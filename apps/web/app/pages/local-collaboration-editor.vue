<template>
  <div class="container mx-auto max-w-6xl p-4">
    ...
    <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-6">
      <h2 class="text-2xl font-bold mb-4 text-blue-900">本地协作编辑器说明</h2>
      <div class="space-y-3 text-gray-700">
        <div>
          <h3 class="font-semibold mb-2 text-blue-800">✨ 主要功能</h3>
          <ul class="list-disc list-inside space-y-1 ml-4">
            <li>
              <strong>实时协作编辑</strong
              >：在同一浏览器的不同标签页中打开此页面，可以实时看到其他标签页的编辑内容
            </li>
            <li>
              <strong>自动保存</strong>：编辑内容会自动保存到浏览器的 IndexedDB 中，无需手动保存
            </li>
            <li><strong>持久化存储</strong>：关闭标签页后重新打开，内容会自动恢复</li>
            <li><strong>JSON 实时显示</strong>：右侧实时显示编辑器的 JSON 数据结构</li>
          </ul>
        </div>
        <div>
          <h3 class="font-semibold mb-2 text-blue-800">📝 使用方法</h3>
          <ol class="list-decimal list-inside space-y-1 ml-4">
            <li>在当前标签页中开始编辑内容</li>
            <li>打开新标签页，访问相同页面（复制 URL 或使用新标签页打开）</li>
            <li>在一个标签页中输入或修改内容，另一个标签页会实时同步显示</li>
            <li>关闭标签页后重新打开，之前的内容会自动恢复</li>
          </ol>
        </div>
        <div>
          <h3 class="font-semibold mb-2 text-blue-800">💡 技术实现</h3>
          <ul class="list-disc list-inside space-y-1 ml-4 text-sm">
            <li>
              使用 <strong>Yjs</strong> 作为 CRDT（无冲突复制数据类型）库，确保多用户编辑的一致性
            </li>
            <li>
              使用 <strong>BroadcastChannel API</strong> 实现同一浏览器不同标签页之间的实时通信
            </li>
            <li>使用 <strong>IndexedDB</strong> 实现本地持久化存储</li>
        ...
        <div class="pt-2 border-t border-blue-200">
          <p class="text-sm text-gray-600">
            <strong>注意</strong
            >：此演示仅支持同一浏览器内的标签页同步。如需跨浏览器或跨设备协作，需要使用 WebSocket
            服务器或 Tiptap Cloud 服务。
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="flex gap-4 h-full flex-1 min-h-[600px]">
      <!-- 编辑器区域 -->
      <div class="min-w-md flex-1 border rounded-lg">
