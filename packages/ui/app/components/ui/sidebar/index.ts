...
export interface SidebarProps {
  /** Position of the sidebar - left or right side of the screen */
  side?: 'left' | 'right';
  /** Visual variant of the sidebar */
  variant?: 'sidebar' | 'floating' | 'inset';
  /** Collapsible behavior when sidebar is minimized */
...
// Sidebar group components for organizing content
...
// Input component for search/filtering
...
// Composable for sidebar state management
export { useSidebar } from './utils';

/**
 * Class variance authority configuration for sidebar menu button variants
...
/**
 * Type definition for sidebar menu button variant props
 * Extracted from the class variance authority configuration
 */
